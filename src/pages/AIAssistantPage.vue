...
import { Bot, Send, User, Trash2, Image, Mic, Navigation, Car, Utensils, Calendar, MapPin, Cloud, Ticket, Hotel } from 'lucide-vue-next'
      ...
      <div class="max-w-3xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xs md:text-sm text-[var(--color-carbon-light)] flex items-center gap-1.5">
